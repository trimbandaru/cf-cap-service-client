		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "clientservice",
									"targetURL": "#comtestclientservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestclientservice-display": {
								"semanticObject": "comtestclientservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.clientservice",
									"url": sap.ui.require.toUrl("com/test/clientservice")
								}
							}
						}
					}
